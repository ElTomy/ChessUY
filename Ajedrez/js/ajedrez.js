    ...
    $.ajax({
      ...
      const id_torneo = urlParams.get('Torn')
        if(id_torneo == 0){
            ...
            $.ajax({
                async: false,
                url:  "/cyberhydra/Ajedrez/php/traigoTorneo.php",
                type: "POST",
                ...
                success: function (data) {
                    ...
                    //:Veo si habian quedado en jaque
                    $.ajax({
                        url:  "/cyberhydra/Ajedrez/php/traigoJaqueTorneo.php",
                        type: "POST",
...
function aceptar_tablas(){
    finalizado = true;
    $.ajax({
        url: "/cyberhydra/Modal/modalAceptoTablas.php",
        type: "POST",
        data: {jugador2:jugador2},
        success: function (data) {
            document.getElementById("modal").innerHTML = data;
...
function rechazar_tablas(){
    $.ajax({
        url: "/cyberhydra/Modal/modalRechazoTablas.php",
        type: "POST",
        data: {jugador2:jugador2},
        success: function (data) {
            document.getElementById("modal").innerHTML = data;
...
function ActualizarEstadisticas(resultado){
    $.ajax({
        url: "/cyberhydra/Ajedrez/php/ELO.php",
        type: "POST",
