...
<div class="torneo-buttons">
    <button><i class="fas fa-save"></i> Guardar como preset</button>
    <button style="background-color: green" onclick="envaPHP()"><i class="fas fa-calendar-plus"></i> Crear</button>
</div>
';
