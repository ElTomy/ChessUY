        ...
        var json2 = jsonMessage['message']
            ...
            switch(tipo){
                ...
                case 5:
                    ...
                    chat = chat.split(":");
                    document.getElementById('chat-box').innerHTML = content +  '<div class="mensaje1-wrapper"> <div class="mensaje1"><a class="nombre" href="/cyberhydra/Profile/Profile.php?Usuario='+chat[0]+'">'+chat[0]+'</a><p>'+chat[1]+'</p></div></div>';
                    break;
            }
    ...
    function mandarChat(){
        var message = document.getElementById('message').value; 
            ...
            if(message.length > 0){
                ...
                var content = document.getElementById('chat-box').innerHTML;
                document.getElementById('chat-box').innerHTML = content +  '<div class="mensaje2-wrapper"> <div class="mensaje2"><a class="nombre" href="/cyberhydra/Profile/Profile.php?Usuario='+name+'">'+name+'</a><p>'+message+'</p></div></div>';
